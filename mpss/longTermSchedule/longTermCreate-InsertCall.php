            ...
            <div class="add-vessel-table-lts m-3 pb-5 d-flex">
                <div class="card">
                                    ...
                                    <tr style="border: 2px solid #F2F2F2; border-radius: 10px; margin:2px;">
                                        ...
                                        <td class="td-1 d-flex m-3">
                                            ...
                                            <div class="right-td w-100" style="width: 50%;">
                                                ...
                                                <a href="longTermCreate-modifyFormula2.php" type="button" class="btn btn-modify disabled mt-3" id="modifyBtn">Modify</a>
                                            </div>
                                        </td>
                                        <td>
                    ...
                    <div class="card-footer ">
                        <a href="longTermCreate2.php" type="button" class="btn w-100" data="Deploy"></a>
                    </div>
                </div>
