                    ...
                    <div class="header-btn">
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#confirmModal" data="Confirm" disabled>

                                </button>
                            </div>
                            <div class="col-6">
                                <!-- <a class="btn btn-reject" role="btn" href="proformaReport3.php" data="Reject"></a> -->
                                <button type="button" class="btn btn-reject" data-bs-toggle="modal" data-bs-target="#rejectModal" data="Reject" disabled>
