    ...
    <div class="container-fluid">
                            ...
                            <div class="card-body">
                                ...
                                <!-- <div class="row">
                                    ...
                                    <div class="col-sm-3 mt-2">
                                        <input id="voyageStart-datePicker">
                                    </div>
                                </div> -->
        ...
        <div class="modal fade" id="confirmModal" tabindex="-1" aria-labelledby="confirmModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="confirmModalLabel">Confirm Voyage Proforma</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body text-center">
                        <p>Are you sure you want to <b>confirm</b> this Voyage Proforma?</p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn" data-bs-dismiss="modal" data="No"></button>
                        <!-- <button type="button" class="btn" data="Yes"></button> -->

                        <a class="btn" role="btn" href="proformaReport2.php" data="Yes"></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="rejectModal" tabindex="-1" aria-labelledby="rejectModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="rejectModalLabel">Reject Voyage Proforma</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body text-center">
                        <p>Are you sure you want to <b>reject</b> this Voyage Proforma?</p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn" data-bs-dismiss="modal" data="No"></button>
                        <!-- <button type="button" class="btn" data="Yes"></button> -->

                        <a class="btn" role="btn" href="proformaReport3.php" data="Yes"></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <script>
            $("#voyageStart-datePicker").kendoDatePicker({
