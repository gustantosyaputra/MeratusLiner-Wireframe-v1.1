...
<head>
    ...
    <script src="./assets/js/proformaEditData2.js"></script>
                ...
                <div class="accordion m-3" id="accordionExample">
                        ...
                        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne">
                            <div class="accordion-body">
                                <form class="row g-3">
                                    ...
                                    <div class="col-4">
                                        <a class="btn btn-success m-3" role="btn" href="#" data="Save & Compute"></a>
                                    </div>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingFour">
                            <btn class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
