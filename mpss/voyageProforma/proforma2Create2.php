...
<head>
    ...
    <script src="./assets/js/proforma2CreateData.js"></script>
    <script src="./assets/js/proforma2Create2.js"></script>
    <script src="./assets/js/proforma2Preview.js"></script>
                            ...
                            <div class="accordion-body">
                                <form class="row g-3">
                                    ...
                                    <div class="col-10 mt-4">
                                        <a class="btn m-1" role="btn" href="proforma2Create3.php" data="Save & Compute"></a>
                ...
                <nav>
                    ...
                    <div class="header-btn">
                        ...
                        <div class="row me-2">
                            ...
                            <div class="col-12">
                                <!-- <a class="btn disabled" role="btn" href="#" data="Save & Submit"></a> -->
                            </div>
                            <!-- <div class="col-2">
                                    <a class="btn" role="btn" href="proformaReport2.php" data="Confirm"></a>
                                </div> -->
