                        ...
                        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                <form class="row g-3">
                                    ...
                                    <div class="col-10">
                                        <a class="btn btn-primary" role="btn" href="proformaCreate3.php" data="Create New Proforma"></a>
                                        <btn type="button" class="btn btn-secondary m-3" data-bs-toggle="modal" data-bs-target="#exampleModal" data="Create from Existing Proforma"></btn>
                                    </div>
                                </form>
                            </div>
                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl" style="max-width: 1520px;">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Create from Existing Proforma</h1>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>01-Sep-22</td>
                                        <td>Jonan</td>
                                        <!-- <td><input type="radio" class="btn-check" name="options-outlined" id="select1" autocomplete="off">
                                            <label class="btn" style="padding: 0.1px 20px;" for="select1" data="Select"></label>
                                        </td> -->
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>01-Sep-22</td>
                                        <td>Faril</td>
                                        <!-- <td><input type="radio" class="btn-check" name="options-outlined" id="select2" autocomplete="off">
                                            <label class="btn" style="padding: 0.1px 20px;" for="select2" data="Select"></label>
                                        </td> -->
                                        <td>
                                            <div class="input-container">
                                                <input type="radio" name="radio" id="select1">
                                                <div class="radio-tile">
                ...
                <div class="modal-footer">
                    <btn type="button" class="btn btn-secondary" data-bs-dismiss="modal" data="Close"></btn>
                    <a class="btn btn-primary" role="btn" href="proformaEdit2.php" data="Apply"></a>
                </div>
            </div>
        </div>
    </div>
